...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class ScheduledUniverseSelectionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.28%"},
            {"Average Loss", "-0.15%"},
            {"Compounding Annual Return", "47.947%"},
            {"Drawdown", "0.700%"},
            {"Expectancy", "1.120"},
            {"Net Profit", "3.494%"},
            {"Sharpe Ratio", "5.614"},
            ...
            {"Estimated Monthly Alpha Value", "$592549.3204"},
            {"Total Accumulated Estimated Alpha Value", "$636167.5342"},
            {"Mean Population Estimated Insight Value", "$12233.9910"},
            {"Mean Population Direction", "61.5385%"},
            {"Mean Population Magnitude", "0%"},
            {"Rolling Averaged Population Direction", "64.8933%"},
